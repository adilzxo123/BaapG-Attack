...
def check_intr():
    try:
        ...
        print("Please turn on your internet . Internet Error")
        sys.exit(2)       
...
{R}
  .d8b.  d8b   db  .d88b.  d8b   db db    db .88b  d88.  .d88b.  db    db .d8888. 
 d8' `8b 888o  88 .8P  Y8. 888o  88 `8b  d8' 88'YbdP`88 .8P  Y8. 88    88 88'  YP 
 88ooo88 88V8o 88 88    88 88V8o 88  `8bd8'  88  88  88 88    88 88    88 `8bo.   
 88~~~88 88 V8o88 88    88 88 V8o88    88    88  88  88 88    88 88    88   `Y8b. 
 88   88 88  V888 `8b  d8' 88  V888    88    88  88  88 `8b  d8' 88b  d88 db   8D 
 YP   YP VP   V8P  `Y88P'  VP   V8P    YP    YP  YP  YP  `Y88P'  ~Y8888P' `8888Y' 
                                                                                  
                                                                                  

 db   dD d888888b db      db      d88888b d8888b. .d8888. 
 88 ,8P'   `88'   88      88      88'     88  `8D 88'  YP 
 88,8P      88    88      88      88ooooo 88oobY' `8bo.   
 88`8b      88    88      88      88~~~~~ 88`8b     `Y8b. 
 88 `88.   .88.   88booo. 88booo. 88.     88 `88. db   8D 
 YP   YD Y888888P Y88888P Y88888P Y88888P 88   YD `8888Y' 
                                                          
                                                          


╱╱╱╱╱ {C}Author : {Y}Shadow {Y}Diluter 
╱╱╱╱╱╱ {C}Tool name  : {Y} anonymous killer
{C}             Version : {G}{version}
 """
os.system('clear')
import os
...
def infinity ():
    ...
    s = st.replace("'","")
    target = s
    #print(f"{B}[{W}{i}{B}] {C} 1400 Sms+Calls Sent ! : {G}{target}")
...
def sms():
	...
	for i in range (1,100000000):
	    try:
	    	   ...
	    	   s = st.replace("'","")
	    	   target = s
	    	   print(f"{B}[{W}{i}{B}] {C} 1400 Sms + Calls : {G}{target}")
	    	   infinity()
	    	   print()
...
def wpbomb():
	...
	print()
	crash = int(
	    input(f'{G}[{W}+{G}] Enter the number of crashes {C}(Max 10000000000) \n\n{G}=> '))
